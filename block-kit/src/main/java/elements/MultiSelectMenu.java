...
public class MultiSelectMenu {
    ...
    public static SectionBlock example01() {
        SectionBlock block = Blocks.section(s -> s.blockId("section678")
                .text(BlockCompositions.markdownText("Pick items from the list"))
                .accessory(BlockElements.multiStaticSelect(m -> m.actionId("text1234")
                        .placeholder(BlockCompositions.plainText("Select items"))
                        .options(List.of(
    ...
    public static SectionBlock example03() {
        SectionBlock block = Blocks.section(s -> s.blockId("section678")
                .text(BlockCompositions.markdownText("Pick users from the list"))
                .accessory(BlockElements.multiUsersSelect(
                        m -> m.actionId("text1234").placeholder(BlockCompositions.plainText("Select users")))));
        return block;
    }
    ...
    public static SectionBlock example04() {
        SectionBlock block = Blocks.section(s -> s.blockId("section678")
                .text(BlockCompositions.markdownText("Pick conversations from the list"))
                .accessory(BlockElements.multiConversationsSelect(
                        m -> m.actionId("text1234").placeholder(BlockCompositions.plainText("Select conversations")))));
        return block;
    }
    ...
    public static SectionBlock example05() {
        SectionBlock block = Blocks.section(s -> s.blockId("section678")
                .text(BlockCompositions.markdownText("Pick channels from the list"))
                .accessory(BlockElements.multiChannelsSelect(
                        m -> m.actionId("text1234").placeholder(BlockCompositions.plainText("Select channels")))));
        return block;
    }
}

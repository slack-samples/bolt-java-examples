...
public class RadioButtons {
    ...
    public static SectionBlock example01() {
        SectionBlock block =
                Blocks.section(s -> s.text(BlockCompositions.plainText("Check out these rad radio buttons"))
                        .accessory(BlockElements.radioButtons(r -> r.actionId("this_is_an_action_id")
                                .initialOption(OptionObject.builder()
                                        .value("A1")
                                        .text(BlockCompositions.plainText("Radio 1"))
                                        .build())
                                .options(List.of(
                                        ...
                                        OptionObject.builder()
                                                .value("A2")
                                                .text(BlockCompositions.plainText("Radio 2"))
                                                .build())))));
        return block;
    }
}
